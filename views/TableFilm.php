    ...
    <button type="submit" class="btn btn-success m-2">Generate PDF</button>
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col">img film</th>
                                        <th scope="col">Nom film</th>
                                        <th scope="col">desc film </th>
                                        <th scope="col"> genre film</th>
                                        <th scope="col">dure film</th>
                         ...
                         foreach ($listfilmC as $films) {
                          ?>
                                    <tr>
                                        ...
                                        <td><?php echo $films['id_film'];?> </td>
                                        <td><?php echo $films['img_film'];?></td>
                                        <td><?php echo $films['nom_film'];?></td>
                                        <td><?php echo $films['desc_film'];?></td>
                                        <td><?php echo $films['genre_film'];?></td>
                                        <td><?php echo $films['dure_film'];?></td>
                                        <td><?php echo $films['salle_film'];?></td>
                                        <td><?php echo $films['id_cinema'];?></td>
                                        <td> <a href="FormUpdateFilm.php?id_film=<?php echo $films['id_film'];?>&id_cinema=<?php echo $films['id_cinema']; ?>" class="btn">modifier</a></td>
                                       <td> <a href="DeleteFilm.php?id_film=<?php echo $films['id_film'];?>&id_cinema=<?php echo $films['id_cinema']; ?>" class="btn">Delete</a></td>
                                       <td> <a href="TableDate.php?id_film=<?php echo $films['id_film']; ?>" class="btn">consulter</a></td>
                                    </tr>
