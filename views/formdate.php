...
if(
    ...
    isset($_POST['date_date'])&&isset($_POST['heure_date'])
   
){
    $dates= new dates($_POST['date_date'],$_POST['heure_date'],$id_film);
    $datesC->ajouterdate($dates);
    echo 'erreur';
                ...
                <div class="row g-4">
                    <div class="col-sm-12 col-xl-6">
                        <div class="bg-secondary rounded h-100 p-4">
                            <h6 class="mb-4">form date</h6>
                        <form   id="myForm" method="post" >
                
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">date de film </label>
                                    <input type="date" class="form-control" id="exampleInputPassword1" name="date_date">
                                </div>
                             
                                <div class="mb-3">
                                    <label for="exampleInputPassword1" class="form-label">heure debut</label>
                                    <input type="text" class="form-control" id="exampleInputPassword1" name="heure_date">
                                </div>
                                <button type="submit" class="btn btn-primary">Register date</button>
                            </form>
                        </div>
                    </div>
            </div>
