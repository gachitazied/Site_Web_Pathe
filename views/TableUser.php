                         ...
                         foreach ($listeUserC as $users) {
                          ?>
                                    <tr>
                                        ...
                                        <td><?php echo $users['adresse_user'];?></td>
                                        <td><?php echo $users['role'];?></td>
                                        <td><?php echo $users['email_user'];?></td>
                                        <td><?php echo $users['password'];?></td>
                                        <td> <a href="FormUpdateUser.php?id_user=<?php echo $users['id_user'];?>" class="btn">modifier</a></td>
                                       <td> <a href="DeleteUser.php?id_user=<?php echo $users['id_user'];?>" class="btn">Delete</a></td>
