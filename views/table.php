                         ...
                         foreach ($listeUserC as $cinemas) {
                          ?>
                                    <tr>
                                       ...
                                       <td> <a href="FormUpdated.php?id_cinema=<?php echo $cinemas['id_cinema']; ?>" class="btn">modifier</a></td>
                                       <td> <a href="TableFilm.php?id_cinema=<?php echo $cinemas['id_cinema']; ?>" class="btn">consulter</a></td>
