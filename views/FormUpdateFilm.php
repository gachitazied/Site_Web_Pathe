...
if (
    isset($_POST['img_film'])&&
    isset($_POST['nom_film'])&&
    isset($_POST['desc_film'])&&
    isset($_POST['genre_film'])&&
    isset($_POST['dure_film'])&&
    isset($_POST['salle_film'])
) {
        ...
        $films = new films(
            ...
            $_POST['salle_film'],
            $id_cinema);
        $filmsC->modifierfilm($id_film,$films);
